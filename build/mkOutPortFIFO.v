...
module mkOutPortFIFO(CLK,
  ...
  reg outPortFIFO_ifc_fifo_mem_0;
  wire outPortFIFO_ifc_fifo_mem_0$D_IN, outPortFIFO_ifc_fifo_mem_0$EN;

  // register outPortFIFO_ifc_fifo_mem_1
  reg outPortFIFO_ifc_fifo_mem_1;
  wire outPortFIFO_ifc_fifo_mem_1$D_IN, outPortFIFO_ifc_fifo_mem_1$EN;

  // register outPortFIFO_ifc_fifo_mem_2
  reg outPortFIFO_ifc_fifo_mem_2;
  wire outPortFIFO_ifc_fifo_mem_2$D_IN, outPortFIFO_ifc_fifo_mem_2$EN;

  // register outPortFIFO_ifc_fifo_mem_3
  reg outPortFIFO_ifc_fifo_mem_3;
  wire outPortFIFO_ifc_fifo_mem_3$D_IN, outPortFIFO_ifc_fifo_mem_3$EN;
  ...
  begin
	...
	outPortFIFO_ifc_fifo_mem_0 <= `BSV_ASSIGNMENT_DELAY 1'd0;
	outPortFIFO_ifc_fifo_mem_1 <= `BSV_ASSIGNMENT_DELAY 1'd0;
	outPortFIFO_ifc_fifo_mem_2 <= `BSV_ASSIGNMENT_DELAY 1'd0;
	outPortFIFO_ifc_fifo_mem_3 <= `BSV_ASSIGNMENT_DELAY 1'd0;
  ...
  begin
    ...
    outPortFIFO_ifc_fifo_mem_0 = 1'h0;
    outPortFIFO_ifc_fifo_mem_1 = 1'h0;
    outPortFIFO_ifc_fifo_mem_2 = 1'h0;
    outPortFIFO_ifc_fifo_mem_3 = 1'h0;
