...
links[1] <- mkConnectPorts(routers[3], 1, routers[2], 1);
links[2] <- mkConnectPorts(routers[2], 2, routers[0], 2);
links[3] <- mkConnectPorts(routers[3], 2, routers[1], 2);
links[4] <- mkConnectPorts(routers[0], 3, routers[1], 3);
links[5] <- mkConnectPorts(routers[2], 3, routers[3], 3);
links[6] <- mkConnectPorts(routers[0], 4, routers[2], 4);
links[7] <- mkConnectPorts(routers[1], 4, routers[3], 4);
