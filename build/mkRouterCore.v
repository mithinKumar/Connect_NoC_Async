...
//
// On Fri Apr 10 02:25:27 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
// CLK                            I     1 clock
// RST_N                          I     1 reset
// in_ports_0_putRoutedFlit_flit_in  I    38
// in_ports_1_putRoutedFlit_flit_in  I    38
...
module mkRouterCore(CLK,
  ...
  input  [37 : 0] in_ports_0_putRoutedFlit_flit_in;
  ...
  input  [37 : 0] in_ports_1_putRoutedFlit_flit_in;
  ...
  wire [36 : 0] out_ports_0_getFlit, out_ports_1_getFlit;
  wire [1 : 0] in_ports_0_getCredits, in_ports_1_getCredits;

  // inlined wires
  wire [36 : 0] hasFlitsToSend_perIn_0$wget, hasFlitsToSend_perIn_1$wget;
  ...
  wire [35 : 0] flitBuffers_0$deq, flitBuffers_0$enq_data_in;
  ...
  reg [31 : 0] CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q6,
  ...
  reg CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q7,
      ...
      active_vc__h16303,
      active_vc__h17404;
  wire [34 : 0] SEL_ARR_hasFlitsToSend_perIn_0_wget__33_BITS_3_ETC___d277,
		SEL_ARR_hasFlitsToSend_perIn_0_wget__33_BITS_3_ETC___d310;
  ...
  assign out_ports_0_getFlit =
	     { IF_outport_encoder_6_BIT_1_7_THEN_NOT_outport__ETC___d225 &&
	       ...
	       SEL_ARR_hasFlitsToSend_perIn_0_wget__33_BITS_3_ETC___d277 } ;
  ...
  assign flitBuffers_0$enq_data_in = in_ports_0_putRoutedFlit_flit_in[36:1] ;
  assign flitBuffers_0$enq_fifo_in = in_ports_0_putRoutedFlit_flit_in[33] ;
  assign flitBuffers_0$EN_enq =
	     EN_in_ports_0_putRoutedFlit &&
	     in_ports_0_putRoutedFlit_flit_in[37] ;
  assign flitBuffers_0$EN_deq = outport_encoder___d60[1] ;

  // submodule flitBuffers_1
  assign flitBuffers_1$deq_fifo_out = fifo_out__h10342 ;
  assign flitBuffers_1$enq_data_in = in_ports_1_putRoutedFlit_flit_in[36:1] ;
  assign flitBuffers_1$enq_fifo_in = in_ports_1_putRoutedFlit_flit_in[33] ;
  assign flitBuffers_1$EN_enq =
	     EN_in_ports_1_putRoutedFlit &&
	     in_ports_1_putRoutedFlit_flit_in[37] ;
  ...
  assign outPortFIFOs_0_0$EN_enq =
	     EN_in_ports_0_putRoutedFlit &&
	     in_ports_0_putRoutedFlit_flit_in[33] == 1'd0 &&
	     in_ports_0_putRoutedFlit_flit_in[37] ;
  ...
  assign outPortFIFOs_0_1$EN_enq =
	     EN_in_ports_0_putRoutedFlit &&
	     in_ports_0_putRoutedFlit_flit_in[33] == 1'd1 &&
	     in_ports_0_putRoutedFlit_flit_in[37] ;
  ...
  assign outPortFIFOs_1_0$EN_enq =
	     EN_in_ports_1_putRoutedFlit &&
	     in_ports_1_putRoutedFlit_flit_in[33] == 1'd0 &&
	     in_ports_1_putRoutedFlit_flit_in[37] ;
  ...
  assign outPortFIFOs_1_1$EN_enq =
	     EN_in_ports_1_putRoutedFlit &&
	     in_ports_1_putRoutedFlit_flit_in[33] == 1'd1 &&
	     in_ports_1_putRoutedFlit_flit_in[37] ;
  ...
  assign NOT_SEL_ARR_credits_0_0_read_credits_1_0_read__ETC___d90 =
	     ...
	     flitBuffers_1$notEmpty[1] &&
	     CASE_outPortFIFOs_1_1first_0_credits_0_1_1_cr_ETC__q3 != 3'd0 ;
  assign SEL_ARR_hasFlitsToSend_perIn_0_wget__33_BITS_3_ETC___d277 =
	     { CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q5,
	       active_vc__h16303,
	       CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q6 } ;
  assign SEL_ARR_hasFlitsToSend_perIn_0_wget__33_BITS_3_ETC___d310 =
	     { CASE_active_in7079_0_hasFlitsToSend_perIn_0wg_ETC__q8,
	       active_vc__h17404,
	       CASE_active_in7079_0_hasFlitsToSend_perIn_0wg_ETC__q9 } ;
  ...
  begin
    case (active_in__h15882)
      1'd0: active_vc__h16303 = hasFlitsToSend_perIn_0$wget[32];
      1'd1: active_vc__h16303 = hasFlitsToSend_perIn_1$wget[32];
    endcase
  end
  ...
  begin
    case (active_in__h17079)
      1'd0: active_vc__h17404 = hasFlitsToSend_perIn_0$wget[32];
      1'd1: active_vc__h17404 = hasFlitsToSend_perIn_1$wget[32];
    endcase
  end
  always@(active_in__h15882 or
  ...
  begin
    case (active_in__h15882)
      1'd0:
	  SEL_ARR_NOT_hasFlitsToSend_perIn_0_whas__31_32_ETC___d249 =
	      !outport_encoder___d60[1] || !hasFlitsToSend_perIn_0$wget[36];
      1'd1:
	  SEL_ARR_NOT_hasFlitsToSend_perIn_0_whas__31_32_ETC___d249 =
	      !outport_encoder___d86[1] || !hasFlitsToSend_perIn_1$wget[36];
    endcase
  end
  always@(active_in__h15882 or
	  outport_encoder___d60 or
  ...
  begin
    case (active_in__h15882)
      1'd0:
	  CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q5 =
	      hasFlitsToSend_perIn_0$wget[34:33];
      1'd1:
	  CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q5 =
	      hasFlitsToSend_perIn_1$wget[34:33];
    endcase
  end
  always@(active_in__h15882 or
	  hasFlitsToSend_perIn_0$wget or hasFlitsToSend_perIn_1$wget)
  ...
  begin
    case (active_in__h15882)
      1'd0:
	  CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q7 =
	      hasFlitsToSend_perIn_0$wget[35];
      1'd1:
	  CASE_active_in5882_0_hasFlitsToSend_perIn_0wg_ETC__q7 =
	      hasFlitsToSend_perIn_1$wget[35];
    endcase
  end
  always@(active_in__h17079 or
	  hasFlitsToSend_perIn_0$wget or hasFlitsToSend_perIn_1$wget)
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  flitBuffers_0$deq[32] != fifo_out__h9707)
	$write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (outport_encoder___d86[1] &&
	  flitBuffers_1$deq[32] != fifo_out__h10342)
	$write("");
    if (RST_N != `BSV_RESET_VALUE)
