...
//
// On Sun May 10 10:25:02 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkInputVCQueues(CLK,
  ...
  // inlined wires
  reg [1 : 0] inputVCQueues_ifc_mf_ifc_cur_head$wget,
	      inputVCQueues_ifc_mf_ifc_new_new_new_new_tail$wget;
  wire [1 : 0] inputVCQueues_ifc_mf_ifc_new_head$wget,
  ...
  assign inputVCQueues_ifc_mf_ifc_new_tail$wget = new_value__h3098 + 2'd1 ;
  assign inputVCQueues_ifc_mf_ifc_new_head$wget = fifoRdPtr__h3230 + 2'd1 ;
  ...
  begin
    case (enq_fifo_in)
      1'd0:
	  inputVCQueues_ifc_mf_ifc_new_new_new_new_tail$wget =
	      inputVCQueues_ifc_mf_ifc_tails_0;
      1'd1:
	  inputVCQueues_ifc_mf_ifc_new_new_new_new_tail$wget =
	      inputVCQueues_ifc_mf_ifc_tails_1;
    endcase
  ...
  begin
    case (deq_fifo_out)
      1'd0:
	  inputVCQueues_ifc_mf_ifc_cur_head$wget =
	      inputVCQueues_ifc_mf_ifc_heads_0;
      1'd1:
	  inputVCQueues_ifc_mf_ifc_cur_head$wget =
	      inputVCQueues_ifc_mf_ifc_heads_1;
    endcase
  ...
  // register inputVCQueues_ifc_mf_ifc_heads_0
  assign inputVCQueues_ifc_mf_ifc_heads_0$D_IN =
	     EN_deq ? x_wget__h1046 : 2'd0 ;
  ...
  // register inputVCQueues_ifc_mf_ifc_heads_1
  assign inputVCQueues_ifc_mf_ifc_heads_1$D_IN =
  ...
  // register inputVCQueues_ifc_mf_ifc_tails_0
  assign inputVCQueues_ifc_mf_ifc_tails_0$D_IN =
	     EN_enq ? x_wget__h975 : 2'd0 ;
  ...
  // register inputVCQueues_ifc_mf_ifc_tails_1
  assign inputVCQueues_ifc_mf_ifc_tails_1$D_IN =
  ...
  assign _dfoo7 =
	     ...
	     inputVCQueues_ifc_mf_ifc_rdFIFO$wget[1] &&
	     NOT_inputVCQueues_ifc_mf_ifc_wrFIFO_whas_5_OR__ETC___d59 ;
  assign fifoRdPtr__h3230 = inputVCQueues_ifc_mf_ifc_cur_head$wget ;
  ...
  assign inputVCQueues_ifc_mf_ifc_wrFIFO_whas_AND_input_ETC___d33 =
	     ...
	     (!EN_deq || !inputVCQueues_ifc_mf_ifc_rdFIFO$wget[1] ||
	      inputVCQueues_ifc_mf_ifc_wrFIFO$wget[0] !=
	      inputVCQueues_ifc_mf_ifc_rdFIFO$wget[0]) ;
  assign new_value__h3098 =
	     inputVCQueues_ifc_mf_ifc_new_new_new_new_tail$wget ;
  assign x__h1620 = inputVCQueues_ifc_mf_ifc_tails_0$D_IN ;
  assign x__h1847 = inputVCQueues_ifc_mf_ifc_heads_0$D_IN ;
  assign x_wget__h1046 = inputVCQueues_ifc_mf_ifc_new_head$wget ;
  assign x_wget__h975 = inputVCQueues_ifc_mf_ifc_new_tail$wget ;
  always@(enq_fifo_in or
