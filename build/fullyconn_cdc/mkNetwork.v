...
//
// On Sun May 10 10:25:01 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkNetwork(CLK,
  ...
  wire [1 : 0] net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$ADDR_1,
	       ...
	       net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN,
	       net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$D_OUT_1;
  wire net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$WE;

  // ports of submodule net_routers_0_router_core
  wire [262 : 0] net_routers_0_router_core$in_ports_0_putRoutedFlit_flit_in,
  ...
  wire [1 : 0] net_routers_0_router_core$in_ports_0_getCredits,
	       ...
	       net_routers_0_router_core$in_ports_3_getCredits,
  ...
  wire [1 : 0] net_routers_1_routeTable_rt_ifc_banks_0_banks_3_rf$ADDR_1,
	       ...
	       net_routers_1_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN,
  ...
  wire [262 : 0] net_routers_1_router_core$in_ports_0_putRoutedFlit_flit_in,
  ...
  wire [1 : 0] net_routers_2_routeTable_rt_ifc_banks_0_banks_3_rf$ADDR_1,
	       ...
	       net_routers_2_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN,
  ...
  wire [262 : 0] net_routers_2_router_core$in_ports_0_putRoutedFlit_flit_in,
  ...
  wire [1 : 0] net_routers_2_router_core$in_ports_0_getCredits,
	       ...
	       net_routers_2_router_core$in_ports_3_getCredits,
  ...
  wire [1 : 0] net_routers_3_routeTable_rt_ifc_banks_0_banks_3_rf$ADDR_1,
	       ...
	       net_routers_3_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN,
  ...
  wire [262 : 0] net_routers_3_router_core$in_ports_0_putRoutedFlit_flit_in,
  ...
  wire [260 : 0] net_routers_3_router_core$out_ports_0_getFlit,
		 ...
		 net_routers_3_router_core$out_ports_3_getFlit;
  ...
  RegFileLoadSyn #( /*file*/ "sample_mesh_routing_0.hex",
		    ...
		    /*binary*/ 32'd0) net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf(.CLK(CLK),
											 ...
											 .D_OUT_1(net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$D_OUT_1));
  ...
  mkRouterCore net_routers_0_router_core(.CLK(CLK),
					 ...
					 .in_ports_3_getCredits(net_routers_0_router_core$in_ports_3_getCredits),
  ...
  mkRouterCore net_routers_2_router_core(.CLK(CLK),
					 ...
					 .in_ports_3_getCredits(net_routers_2_router_core$in_ports_3_getCredits),
  ...
  mkRouterCore net_routers_3_router_core(.CLK(CLK),
					 ...
					 .out_ports_3_getFlit(net_routers_3_router_core$out_ports_3_getFlit));
  ...
  assign net_routers_0_routeTable_rt_ifc_banks_0_banks_2_rf$ADDR_1 =
	     net_routers_2_router_core$out_ports_1_getFlit[258:257] ;
  ...
  // submodule net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf
  assign net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$ADDR_1 =
  ...
  assign net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN = 2'h0 ;
  ...
  assign net_routers_0_router_core$in_ports_2_putRoutedFlit_flit_in =
	     { net_routers_2_router_core$out_ports_1_getFlit,
	       net_routers_0_routeTable_rt_ifc_banks_0_banks_2_rf$D_OUT_1 } ;
  assign net_routers_0_router_core$in_ports_3_putRoutedFlit_flit_in =
	     { net_routers_3_router_core$out_ports_1_getFlit,
	       net_routers_0_routeTable_rt_ifc_banks_0_banks_3_rf$D_OUT_1 } ;
  ...
  assign net_routers_0_router_core$EN_in_ports_3_putRoutedFlit = 1'd1 ;
  assign net_routers_0_router_core$EN_in_ports_3_getCredits = 1'd1 ;
  ...
  assign net_routers_1_routeTable_rt_ifc_banks_0_banks_1_rf$ADDR_1 =
	     net_routers_0_router_core$out_ports_1_getFlit[258:257] ;
  ...
  assign net_routers_1_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN = 2'h0 ;
  ...
  assign net_routers_1_router_core$out_ports_2_putCredits_cr_in =
	     net_routers_2_router_core$in_ports_2_getCredits ;
  assign net_routers_1_router_core$out_ports_3_putCredits_cr_in =
	     net_routers_3_router_core$in_ports_2_getCredits ;
  ...
  assign net_routers_1_router_core$EN_out_ports_3_putCredits = 1'd1 ;
  ...
  assign net_routers_2_routeTable_rt_ifc_banks_0_banks_1_rf$ADDR_1 =
	     net_routers_0_router_core$out_ports_2_getFlit[258:257] ;
  ...
  assign net_routers_2_routeTable_rt_ifc_banks_0_banks_2_rf$ADDR_1 =
	     net_routers_1_router_core$out_ports_2_getFlit[258:257] ;
  ...
  assign net_routers_2_routeTable_rt_ifc_banks_0_banks_3_rf$ADDR_1 =
	     net_routers_3_router_core$out_ports_3_getFlit[258:257] ;
  assign net_routers_2_routeTable_rt_ifc_banks_0_banks_3_rf$ADDR_IN = 2'h0 ;
  assign net_routers_2_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN = 2'h0 ;
  ...
  assign net_routers_2_router_core$EN_in_ports_3_getCredits = 1'd1 ;
  ...
  assign net_routers_3_routeTable_rt_ifc_banks_0_banks_2_rf$ADDR_1 =
	     net_routers_1_router_core$out_ports_3_getFlit[258:257] ;
  ...
  assign net_routers_3_routeTable_rt_ifc_banks_0_banks_3_rf$D_IN = 2'h0 ;
  ...
  assign net_routers_3_router_core$out_ports_2_putCredits_cr_in =
	     net_routers_1_router_core$in_ports_3_getCredits ;
  assign net_routers_3_router_core$out_ports_3_putCredits_cr_in =
	     net_routers_2_router_core$in_ports_3_getCredits ;
  ...
  assign net_routers_3_router_core$EN_out_ports_3_getFlit = 1'd1 ;
  assign net_routers_3_router_core$EN_out_ports_3_putCredits = 1'd1 ;
  ...
  begin
	...
	$write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_0_router_core$out_ports_1_getFlit[260]) $write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_0_router_core$out_ports_2_getFlit[260]) $write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_0_router_core$out_ports_3_getFlit[260]) $write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_1_router_core$out_ports_1_getFlit[260]) $write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_1_router_core$out_ports_2_getFlit[260]) $write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_1_router_core$out_ports_3_getFlit[260]) $write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_2_router_core$out_ports_1_getFlit[260]) $write("");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (net_routers_3_router_core$out_ports_3_getFlit[260]) $write("");
  end
