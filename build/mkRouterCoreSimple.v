...
//
// On Fri Apr 10 02:25:31 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkRouterCoreSimple(CLK,
  ...
  reg [31 : 0] CASE_active_in2655_0_hasFlitsToSend_perIn_0wg_ETC__q3,
  ...
  wire [34 : 0] SEL_ARR_hasFlitsToSend_perIn_0_wget__41_BITS_3_ETC___d180,
		SEL_ARR_hasFlitsToSend_perIn_0_wget__41_BITS_3_ETC___d203;
  ...
  assign out_ports_0_getFlit =
	     { IF_outport_encoder_8_BIT_1_9_THEN_NOT_outport__ETC___d133 &&
	       SEL_ARR_hasFlitsToSend_perIn_0_whas__39_AND_ha_ETC___d162,
	       CASE_active_in2655_0_hasFlitsToSend_perIn_0wg_ETC__q4,
	       SEL_ARR_hasFlitsToSend_perIn_0_wget__41_BITS_3_ETC___d180 } ;
  ...
  assign IF_outport_encoder_8_BIT_1_9_THEN_outport_enco_ETC___d185 =
	     outport_encoder___d88[1] ?
	       ...
	       outport_encoder___d62[1] && outport_encoder___d62[0] :
	       outport_encoder___d62[1] && outport_encoder___d62[0] ;
  assign SEL_ARR_hasFlitsToSend_perIn_0_wget__41_BITS_3_ETC___d180 =
  ...
  assign SEL_ARR_hasFlitsToSend_perIn_0_wget__41_BITS_3_ETC___d203 =
	     { CASE_active_in3964_0_hasFlitsToSend_perIn_0wg_ETC__q5,
	       CASE_active_in3964_0_hasFlitsToSend_perIn_0wg_ETC__q6,
	       CASE_active_in3964_0_hasFlitsToSend_perIn_0wg_ETC__q7 } ;
  ...
  begin
    case (active_in__h12655)
      1'd0:
	  SEL_ARR_NOT_hasFlitsToSend_perIn_0_whas__39_40_ETC___d157 =
	      !outport_encoder___d62[1] || !hasFlitsToSend_perIn_0$wget[36];
      1'd1:
	  SEL_ARR_NOT_hasFlitsToSend_perIn_0_whas__39_40_ETC___d157 =
	      !outport_encoder___d88[1] || !hasFlitsToSend_perIn_1$wget[36];
    endcase
  end
  always@(active_in__h12655 or
	  outport_encoder___d62 or
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  flitBuffers_0$deq[32] != fifo_out__h8915)
	$write("");
    if (RST_N != `BSV_RESET_VALUE)
      if (outport_encoder___d88[1] &&
	  flitBuffers_1$deq[32] != fifo_out__h9550)
	$write("");
    if (RST_N != `BSV_RESET_VALUE)
